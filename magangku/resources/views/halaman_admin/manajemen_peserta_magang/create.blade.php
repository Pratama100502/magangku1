                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('peserta.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" id="tambah-anggota" class="btn btn-sm btn-primary mt-2" style="background-color: #343a40; border-color: #343a40;">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function createAnggotaField() {
                ...
                div.innerHTML = `
        <div class="col-md-5">
            <input type="text" class="form-control" name="anggota[${anggotaCount}][nama_anggota]"
                placeholder="Nama Anggota">
        </div>
        <div class="col-md-5">
            <input type="text" class="form-control" name="anggota[${anggotaCount}][no_hp_anggota]"
